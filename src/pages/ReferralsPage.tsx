import { Award, Copy, TrendingUp, Users, Target, Shield, Zap, ChevronRight, Share2, Star, BarChart3 } from 'lucide-react';
    ...
    <div className="p-6 lg:p-10 space-y-10 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex gap-4 w-full md:w-auto">
          <Button asChild variant="outline" className="flex-1 md:flex-none h-12 rounded-xl border-primary/20 hover:bg-primary/5">
            <Link to="/analytics">
              <BarChart3 className="mr-2 h-4 w-4 text-primary" />
              Advanced Analytics
            </Link>
          </Button>
          <Button onClick={copyReferralLink} className="flex-1 md:flex-none h-12 rounded-xl font-bold uppercase tracking-widest text-xs px-6">
