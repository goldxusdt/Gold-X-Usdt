...
import { getProfile, updateProfile, updateCompoundingPreference } from '@/db/api';
             ...
             <CardContent className="p-8 space-y-8">
                <div className="flex items-center justify-between p-4 rounded-2xl bg-accent/30 border border-white/5">
                   <div className="space-y-0.5">
                      <p className="font-bold uppercase tracking-widest text-[10px]">Compounding ROI</p>
                      <p className="text-xs text-muted-foreground">Reinvest 10% returns</p>
                   </div>
                   <Switch checked={isCompounding} onCheckedChange={handleCompoundingToggle} className="data-[state=checked]:bg-primary" />
                </div>
